...
class SignUpController(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Line
        tk.Frame(login_frame,width=300, height=1, bg='black').place(x=92, y=258)

        tk.Checkbutton(login_frame, text="Show password", bg=LOGIN_COLOR, command=self.show_password).place(x=85, y=280)
