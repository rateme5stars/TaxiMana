...
class Summary(tk.Frame):
    def __init__(self, parent, controller):
        ...
        for m in self.last_12_month_df:
            my_income = sum(m['income'])
            my_expense = int(sum(m['salary']))
            inc = my_income / 50000000000
            exp = my_expense / 50000000000
            in_pro.append(inc)
            ex_pro.append(exp)
        
        em_height = np.array(in_pro) * 500
        co_height = np.array(ex_pro) * 500
        ...
        tk.Label(self, text='50', font=(FONT, 11), bg='white').place(x=288, y=90)

        tk.Frame(self, bg='black', width=5, height=1).place(x=312, y=100+int(500*0.2))
        tk.Label(self, text='40', font=(FONT, 11), bg='white').place(x=288, y=90+int(500*0.2))

        tk.Frame(self, bg='black', width=5, height=1).place(x=312, y=100+int(500*0.4))
        tk.Label(self, text='30', font=(FONT, 11), bg='white').place(x=288, y=90+int(500*0.4))

        tk.Frame(self, bg='black', width=5, height=1).place(x=312, y=100+int(500*0.6))
        tk.Label(self, text='20', font=(FONT, 11), bg='white').place(x=288, y=90+int(500*0.6))

        tk.Frame(self, bg='black', width=5, height=1).place(x=312, y=100+int(500*0.8))
        tk.Label(self, text='10', font=(FONT, 11), bg='white').place(x=288, y=90+int(500*0.8))
